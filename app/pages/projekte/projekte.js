...
var ProjektePage = (function () {
    function ProjektePage(navController, global) {
        this.navController = navController;
        this.global = global;
        this.nav_title = 'Projekte';
        this.title = 'Projekte';
    }
    ProjektePage.prototype.openPage = function () {
        // with BACK-Button
        this.navController.push(ProjektePage);
        // with MENU-Button
        //this.navController.setRoot(ProjektePage);
    };
    ProjektePage = __decorate([
        core_1.Component({
...
exports.ProjektePage = ProjektePage;
